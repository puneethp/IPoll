...
public class WardUserAddVoterId extends BaseAction {
					...
					User user = (User)req.getSession(false).getAttribute("user");
								...
								&&req.getParameter("curState")!=null&&req.getParameter("curWardNo")!=null)
						{
							if(userPhoto!=null&&userPhotoContentType!=null&&userPhotoFilename!=null)
							{
								...
								if(serv.writeVoterIdWard(name, surName, currAdd, currState, currCity, currWardNo, dob, userImage, pobAdd, null, fathersName, sex,
