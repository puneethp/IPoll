...
public class User {
	...
	public static final String CANDIDATEPARTY = "CandidateParty";
	public static final String PARTYHEAD = "PartyHead";
	...
	public String toString() {
		return "id: "+id+" createdOn: "+createdOn+" lastLogin: "+lastLogin+" type: "+type;
	}
}
