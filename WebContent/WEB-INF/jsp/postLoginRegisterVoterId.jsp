...
<script language="javascript" type="text/javascript">
	...
	function hasFilledfields() {
		if (document.getElementById('name').value.length != 0
				...
				&& document.getElementById('curL1').value.length != 0
				&& document.getElementById('pobL1').value.length != 0
				&& document.getElementById('userPhoto').value.length != 0
				&& document.getElementById('curState').value.length != 0
				&& document.getElementById('curCity').value.length != 0
				&& document.getElementById('curWardNo').value.length != 0) {
	...
	function verify_ward() {
		...
		var pval = "city=" + document.getElementById("curCity").value
				+ "&state=" + document.getElementById("curState").value
				+ "&wardno=" + document.getElementById("curWardNo").value;
...
<form action="regVoterId.action" method="post"
	...
	<fieldset>
		...
		</select> <label>Sex :</label> <label class="radio">Male<input checked="checked"
