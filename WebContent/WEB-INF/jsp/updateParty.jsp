...
<div class="main">
	...
	<s:form onsubmit="return verifyForm()" method="post" enctype="multipart/form-data" action="updateParty.action">
		<s:label id="error" />
		<tr>
			<td><label>Name: </label></td>
			<td><input type="text" id="partyname" value="${requestScope.partycard.partyname}" name="partyname" /></td>
		</tr>
		<tr>
